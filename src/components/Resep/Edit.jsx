...
export default function EditResep() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const [resepRes, kategoriRes, asalRes] = await Promise.all([
          axios.get(`https://project-apipaw-2.vercel.app/api/resep/${id}`),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://project-apipaw-2.vercel.app/api/resep/${id}`,
        submitData
      );
    ...
    <div className="container mt-5">
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="col-md-4">
            <div className="mb-3">
              ...
              <select
                ...
                id="kategoriId"
                name="kategoriId"
                value={formData.kategoriId?._id || formData.kategoriId || ""}
                onChange={handleChange}
              >
          ...
          <div className="col-md-4">
            <div className="mb-3">
              ...
              <select
                ...
                id="asalId"
                name="asalId"
                value={formData.asalId?._id || formData.asalId || ""}
                onChange={handleChange}
              >
        ...
        <div className="mb-3">
          ...
          {formData.bahan && formData.bahan.map((bahan, index) => (
        ...
        <div className="mb-3">
          ...
          {formData.langkah && formData.langkah.map((langkah, index) => (
            <div key={index} className="input-group mb-2">
